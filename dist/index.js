...
// node_modules/.pnpm/@stripe+agent-toolkit@file+..+typescript_@langchain+core@0.3.40_openai@4.97.0_zod@3.25.76___@_6l3sx3vgrkmavd4546x5seni4a/node_modules/@stripe/agent-toolkit/modelcontextprotocol/index.js
var require_modelcontextprotocol = __commonJS({
  "node_modules/.pnpm/@stripe+agent-toolkit@file+..+typescript_@langchain+core@0.3.40_openai@4.97.0_zod@3.25.76___@_6l3sx3vgrkmavd4546x5seni4a/node_modules/@stripe/agent-toolkit/modelcontextprotocol/index.js"(exports2, module2) {
    "use strict";
...
`;
    ...
    var import_zod17 = require_zod();
    var searchPaymentIntentsPrompt = (context = {}) => {
      return `
...
`;
    ...
    var searchPaymentIntents = async (stripe, context, params) => {
      try {
        const searchParams = {
          query: params.query,
    ...
    var searchPaymentIntentsAnnotations = () => ({
      destructiveHint: false,
      idempotentHint: true,
      openWorldHint: true,
      readOnlyHint: true,
    ...
    var searchPaymentIntentsParameters = (context = {}) => {
      return import_zod17.z.object({
        query: import_zod17.z.string().describe(
        ...
        page: import_zod17.z.string().optional().describe("A cursor for pagination across multiple pages of results.")
      });
    };
    var tool17 = (context) => ({
    ...
    var searchPaymentIntents_default = tool17;
    var import_zod18 = require_zod();
    ...
    var listSubscriptionsParameters = (context = {}) => {
      const schema = import_zod18.z.object({
        customer: import_zod18.z.string().optional().describe("The ID of the customer to list subscriptions for."),
        price: import_zod18.z.string().optional().describe("The ID of the price to list subscriptions for."),
        ...
        limit: import_zod18.z.number().int().min(1).max(100).optional().describe(
          "A limit on the number of objects to be returned. Limit can range between 1 and 100."
        )
      });
      if (context.customer) {
...
`;
    ...
    var listSubscriptions_default = tool18;
    var import_zod19 = require_zod();
    ...
    var cancelSubscriptionParameters = (_context = {}) => {
      return import_zod19.z.object({
        subscription: import_zod19.z.string().describe("The ID of the subscription to cancel.")
      });
    };
...
`;
    ...
    var cancelSubscription_default = tool19;
    var import_zod20 = require_zod();
  ...
  `;
    ...
    var updateSubscriptionParameters = (_context = {}) => {
      return import_zod20.z.object({
        subscription: import_zod20.z.string().describe("The ID of the subscription to update."),
        proration_behavior: import_zod20.z.enum(["create_prorations", "none", "always_invoice", "none_implicit"]).optional().describe(
          "Determines how to handle prorations when the subscription items change."
        ),
        items: import_zod20.z.array(
          import_zod20.z.object({
            id: import_zod20.z.string().optional().describe("The ID of the subscription item to modify."),
            price: import_zod20.z.string().optional().describe("The ID of the price to switch to."),
            quantity: import_zod20.z.number().int().min(1).optional().describe("The quantity of the plan to subscribe to."),
            deleted: import_zod20.z.boolean().optional().describe("Whether to delete this item.")
          })
    ...
    var updateSubscription_default = tool20;
    var import_zod21 = require_zod();
...
`;
    var searchDocumentationParameters = (_context = {}) => import_zod21.z.object({
      question: import_zod21.z.string().describe(
        "The user question about integrating with Stripe will be used to search the documentation."
      ),
      language: import_zod21.z.enum(["dotnet", "go", "java", "node", "php", "ruby", "python", "curl"]).optional().describe(
    ...
    var searchDocumentation_default = tool21;
...
`;
    var listDisputesParameters = (_context = {}) => import_zod22.z.object({
      charge: import_zod22.z.string().optional().describe(
        "Only return disputes associated to the charge specified by this charge ID."
      ),
      payment_intent: import_zod22.z.string().optional().describe(
        "Only return disputes associated to the PaymentIntent specified by this PaymentIntent ID."
      ),
      limit: import_zod22.z.number().int().min(1).max(100).default(10).optional().describe(
        "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10."
      )
    });
    ...
    var listDisputes_default = tool22;
    var import_zod23 = require_zod();
...
`;
    var updateDisputeParameters = (_context = {}) => import_zod23.z.object({
      dispute: import_zod23.z.string().describe("The ID of the dispute to update"),
      evidence: import_zod23.z.object({
        cancellation_policy_disclosure: import_zod23.z.string().max(2e4).optional().describe(
          "An explanation of how and when the customer was shown your refund policy prior to purchase."
        ),
        duplicate_charge_explanation: import_zod23.z.string().max(2e4).optional().describe(
          "An explanation of the difference between the disputed charge versus the prior charge that appears to be a duplicate."
        ),
        uncategorized_text: import_zod23.z.string().max(2e4).optional().describe("Any additional evidence or statements.")
      }).optional().describe(
        "Evidence to upload, to respond to a dispute. Updating any field in the hash will submit all fields in the hash for review."
      ),
      submit: import_zod23.z.boolean().optional().describe(
    ...
    var updateDispute_default = tool23;
    var tools = (context) => [
      ...
      searchPaymentIntents_default(context),
      ...
      constructor({
        ...
        filteredTools.forEach((tool24) => {
          this.tool(
            tool24.method,
            tool24.description,
            tool24.inputSchema.shape,
            tool24.annotations,
            async (arg, _extra) => {
              const result = await this._stripe.run(tool24.method, arg);
              return {
                content: [
                  {
                    type: "text",
...
exports.main = main;
var modelcontextprotocol_1 = require_modelcontextprotocol();
var stdio_js_1 = require("@modelcontextprotocol/sdk/server/stdio.js");
var colors_1 = require("colors");
var ACCEPTED_ARGS = ["api-key", "tools", "stripe-account"];
var ACCEPTED_TOOLS = [
  "coupons.create",
  "coupons.read",
  "customers.create",
...
function handleError(error) {
  console.error((0, colors_1.red)("\n\u{1F6A8}  Error initializing Stripe MCP server:\n"));
